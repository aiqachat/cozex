...
<div id="app" v-cloak>
    <app-volcengine-choose @account="changeAccount" :dialog="newDialog" @close="closeDialog" url="<?=$url;?>" title="字幕打轴"></app-volcengine-choose>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            submit() {
                this.$refs.data.validate((valid) => {
                    if (valid) {
                        ...
                        request({
                            params: {r: 'netb/volcengine/titling'},
                            method: 'post',
            ...
            getList(type = 1) {
                ...
                let param = Object.assign({r: 'netb/volcengine/titling', page: this.page}, this.searchData);
                request({
                    params: param,
                }).then(e => {
                    if (e.data.code === 0) {
