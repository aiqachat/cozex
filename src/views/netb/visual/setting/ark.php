<template id="ark">
    <el-form @submit.native.prevent :model="form" :rules="rules" label-width="120px" :ref="formName">
        ...
        <!-- 服务提示 -->
        <service-alert
            service-url="https://console.volcengine.com/ark/region:ark+cn-beijing/openManagement?LLM=%7B%7D&OpenTokenDrawer=false&tab=ComputerVision"
            service-description="请先开通火山方舟模型服务后才能使用此功能，开通后即可获得相应的接口调用权限。">
        </service-alert>

        <!-- 密钥管理 -->
        <key-management :form="form" :keys="keys" key-type="1" key-title="火山、API Key管理" key-label="火山账号"
            :show-api-key="true"
            api-key-url="https://console.volcengine.com/ark/region:ark+cn-beijing/apiKey?apikey=%7B%7D"
