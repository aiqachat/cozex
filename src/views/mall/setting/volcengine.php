    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column label="应用名称" prop="name" width="250"></el-table-column>
        ...
        methods: {
            ...
            destroy: function (column) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    request({
                        params: {r: 'mall/setting/volcengine-destroy'},
                        data: {id: column.id},
                        method: 'post'
                    }).then(e => {
                        this.getList()
            ...
            submit() {
                this.$refs.data.validate((valid) => {
                    if (valid) {
                        ...
                        request({
                            params: {r: 'mall/setting/volcengine'},
                            method: 'post',
                            data: this.data,
                        }).then(e => {
                            if (e.data.code === 0) {
            ...
            getList() {
                this.listLoading = true;
                request({
                    params: {r: 'mall/setting/volcengine', page: this.page},
                }).then(e => {
                    if (e.data.code === 0) {
