    ...
    <div class="table-body">
        <div class="card-container">
            <el-card style="width: 50vw;">
                <div slot="header">
                    <span>字幕列表</span>
                    <el-button size="mini" type="text" style="float: right;" @click="$navigate({r:'mall/volcengine/generate'})">更多</el-button>
                </div>
...
>>>>>>> aa46331817a85d4745f22daa8a771a67c28a9ec7
                    ...
                    <el-table-column label="操作" width="150" fixed="right">
                        <template slot-scope="scope">
                            <el-tooltip effect="dark" content="下载" placement="top" v-if="scope.row.status == 2">
            ...
            <el-card style="margin-left: 10px;width: 50vw;">
                ...
                <el-form ref="data" :model="data" :rules="rules" label-width="180px">
                    <el-form-item label="音视频文件" prop="file" style="width: 25vw;">
                        <el-input v-model="data.file" size="small">
                            <template slot="append">
                                <app-attachment v-model="data.file" :type="'video'">
                                    <el-button style="padding: 12px;">上传文件</el-button>
                                </app-attachment>
                            </template>
                        </el-input>
                    </el-form-item>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList(type = 1) {
                ...
                let param = Object.assign({r: 'mall/volcengine/vc'}, this.searchData);
                request({
                    params: param,
                }).then(e => {
                    if (e.data.code === 0) {
