    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'mall/knowledge/file-list', id: knowledge_id})">文件列表</span></el-breadcrumb-item>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            onSubmit(){
                ...
                request({
                    params: {r: 'mall/knowledge/add-local'},
                    data: self.form,
                    method: 'post'
                }).then(e => {
                    if (e.data.code === 0) {
                        ...
                        setTimeout(function (){
                            navigateTo({r:'mall/knowledge/file-list', id: self.knowledge_id})
                        }, 1000)
                    }else{
