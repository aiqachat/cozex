...
class VideoForm extends Model
{
    ...
    public function public()
    {
        ...
        $model = VisualVideo::findOne(['id' => $this->id, 'mall_id' => \Yii::$app->mall->id]);
        if (!$model) {
    ...
    public function batchDisable()
    {
        ...
        $models = VisualVideo::find()->where(['id' => $this->ids, 'mall_id' => \Yii::$app->mall->id])->all();
